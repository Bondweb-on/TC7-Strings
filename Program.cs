...
namespace TC7_Strings
{
    class Program
    {
        ...
        {
            string value1 = "Hola";
            // Que voy a buscar, Por qué lo voy a remplazar
            ...
            MostrasEjemploSplit("fresa mora frambuesa", "m");
            MostrasEjemploSplit("fresa  mora frambuesa", " ");
            MostrasEjemploSplit("fresa  mora frambuesa".Replace("  ", " "), " ");
            // Regex
            // Replace (" ", "") -> Borrar espacios
            MostrasEjemploSplit("1 +4 + 6 +3+5 + 22".Replace(" ", ""), "+");

            MostrasEjemploSplit("fresa mora frambuesa", "mora");
            ...
            Console.WriteLine("bert, Jo? " + nombres.Contains("vert, Jo")); //false
            ...
            // Los siguientes dos son equivalentes y hacen lo mismo 
            int a = int.Parse("2");
        ...
        // public -> accesoble desde cualquier archivo
        ...
        public static void MostrasEjemploSplit(string valor, string separador)
        {
            Console.WriteLine("-----");
